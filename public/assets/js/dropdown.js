document.addEventListener("DOMContentLoaded", function() {
    ...
    dropdownButtonDownload.addEventListener('click', function (e) {
        e.preventDefault();
        dropdownMenuDownload.classList.toggle('open');
    });

    document.addEventListener('click', function (event) {
        if (!dropdownButtonDownload.contains(event.target) && !dropdownMenuDownload.contains(event.target)) {
            dropdownMenuDownload.classList.remove('open');
        }
    });
